...
This is the TypeScript/Node.js implementation of Agent VCR. It provides the same functionality as the Python version with full cross-language compatibility — recordings created with Python can be replayed in TypeScript and vice versa.
